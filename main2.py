...
'voice', 'wednesday', 'weight','please wait for sometime','what is your mobile number','what are you doing','are you busy']
        ...
        with sr.Microphone() as source:
                # image   = "Automatic-Indian-Sign-Language-Translator-ISL-master/signlang.png"
                        ...
                        try:
                                ...
                                if(a.lower()=='goodbye' or a.lower()=='good bye' or a.lower()=='bye'):
                                    ...
                                    class ImageLabel(tk.Label):
                                            """label to displays images, and plays them if they are gifs"""
                                            def load(self, im):
                                    ...
                                    lbl = ImageLabel(root)
                                    lbl.pack()
                                    lbl.load(r'Automatic-Indian-Sign-Language-Translator-ISL-master/ISL_Gifs/{0}.gif'.format(a.lower()))
                                    root.mainloop()
                                else:
                                    for i in range(len(a)):
                                                    if(a[i] in arr):
                                            
                                                            ImageAddress = 'Automatic-Indian-Sign-Language-Translator-ISL-master/letters/'+a[i]+'.jpg'
